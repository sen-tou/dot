...
cd ~ && curl -O https://raw.githubusercontent.com/stvbyr/dot/oh-my-zsh-fix-install/init_dotfiles.sh && chmod +x ./init_dotfiles.sh

# install the dotfiles
./init_dotfiles.sh https -i && ./init_dotfiles.sh https -I
